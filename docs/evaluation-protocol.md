...
| Capability Lab: grader-legible reproducer (#237) | Six synthetic TRAIN archetypes, external raw-channel grader, failure-stage attribution, paired baseline/candidate runner, content-hashed frozen candidate | Harness-validated with scripted shapes only; a registered real-agent pilot is required before any capability claim, and transfer belongs on the reserved unseen family |
