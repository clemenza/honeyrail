...
export function createApp({
  ...
  token = process.env.HONEYRAIL_TOKEN || process.env.AGENT_GATEWAY_TOKEN,
  accounts = process.env.HONEYRAIL_ACCOUNTS || process.env.AGENT_GATEWAY_ACCOUNTS,
  sessionSecret = process.env.HONEYRAIL_SESSION_SECRET || process.env.AGENT_GATEWAY_SESSION_SECRET,
  auth: providedAuth,
  publicBaseUrl = process.env.HONEYRAIL_PUBLIC_BASE_URL || process.env.AGENT_GATEWAY_PUBLIC_BASE_URL,
